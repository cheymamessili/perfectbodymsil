            ...
            <div class="col-1">
                <div class="col-1-top">
                    <ul>
                        ...
                        <li class="current"><a href="./users.php"><i class="fas fa-code"></i>Users</a></li>
 ...
 <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="color: #7c7989;"><?php echo $row['username'] ?> </td>
            <td style="color: #6d68ab;"><?php echo $row['useremail'] ?></td>
